...
//un puntero a una funcion (destr) que recibe un dato y lo destruye
...
int avl_nodo_altura2(AVL_Nodo* raiz){
  if (raiz == NULL){
    return 0;
  }
  else{
...
// avl_nodo_factor_balance: Funcion interna que retorna el factor de balance de un nodo.
